                ...
                <?php 
                    while ($rowT = mysqli_fetch_assoc($resultTag)) {
                        ...
                        echo '<label class="TagLbl" for="'.$TagID.'Tag"> 
                            <input id="'.$TagID.'Tag" type="radio" name="PostTags" value="'.$TagID.'" required>'.$TagName.'
                        </label><br>';
                    }
                ?>    
            </fieldset>  
<br>
            <fieldset id="TypeTag" class="RadioTags"> 
                <legend>Type:</legend>
                <label for="PaidTag">
                <input id="PaidTag" type="radio" name="ClassType" value="Paid" required>Paid       
            </label><br>
            <label for="FreeTag">
                <input id="FreeTag" type="radio" name="ClassType" value="Free" required>Free
            </label><br>
            <label for="UpcomingTag">
                <input id="UpcomingTag" type="radio" name="ClassType" value="Upcoming" required>Upcoming 
            </label>     
            </fieldset>  
            <br>
