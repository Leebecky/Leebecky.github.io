...
<br>
            <!--^ Images for the post --> 
            <label for="PostImage" id="Label">Please ensure that the image is named as per the Title of the post!</label>
...
<br>               
                ...
                <label id="TagsARLbl" for="TagsAR">Tags :
                    <select name="PostTagsAR" id="TagsAR" class="UserFilter" required>
...
<br>    
            ...
            <ul class="Content" id="ArticleContent" contenteditable="true" spellcheck="true"><li></li></ul>
                <!-- Recipe Content uses numbered list -->
            <ol class="Content" id="RecipeContent" contenteditable="true" spellcheck="true"><li></li></ol>
                </div>
...
<br>
                    ...
                    <input id="IngredientsNo"type="number" placeholder="0" min=1> 
