...
<br><br>
                     ...
                     <input class="Box" id="CardNum" type="text" name="CardNum"
...
<br><br>
                    ...
                    <input type="password" class="Box" placeholder="Enter new pasword (Min: 4 characters)" 
                            name="NewPassword">
<br><br>
                ...
                <button type="button" id="SaveSettingsBtn" name="SaveSettingsBtn" onclick="SettingsSubmit(ValidateCard())">Save Settings</button>
</form>
