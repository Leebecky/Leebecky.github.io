...
$sql = "SELECT * FROM subscription INNER JOIN classes USING (ClassID) ORDER BY Number ASC";
...
<html>
    ...
    <body id="AdminPayManagerBody" Class="ManagerBody">
        ...
        <table class="Manager" id="PayManager">
            <form method="POST" action="Scripts/Script_PayManager.php">     
            <tr>
                <th>No.</th>
                <th>User ID</th>
                <th>Class ID</th>
